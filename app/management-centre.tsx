...
type Material={id:string;schoolYear:number;folderId:string;title:string;documentType:string;sourceUrl:string;openUrl:string;uploaded:boolean;notes:string;visibility:string;ownerName:string;createdAt:string;mappingStatus?:string;standardCode?:string};
