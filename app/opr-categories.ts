...
export const oprFolderTree: readonly OprFolderNode[] = [
  ...
  { name: "Kokurikulum", children: [
    { name: "Pengurusan Kokurikulum" },
    { name: "Badan Beruniform", children: [
      { name: "Kadet JPJ" },
      { name: "Persekutuan Pengakap" },
      { name: "Kadet Remaja Sekolah" },
      { name: "Persatuan Pandu Puteri" },
      { name: "PPIM" },
      { name: "Kadet Bomba dan Penyelamat" },
      { name: "Kadet Polis" },
    ] },
    { name: "Kelab dan Persatuan", children: [
      { name: "Persatuan Bahasa Melayu" },
      { name: "Persatuan Bahasa Inggeris/Scrabble" },
      { name: "Persatuan Bahasa Arab" },
      { name: "Persatuan PAI" },
      { name: "Kelab Kesihatan" },
      { name: "Kelab Kesenian Islam/Seni Muzik" },
      ...
      { name: "Kelab PNB" },
      { name: "Kelab STEM" },
      { name: "Kelab Inovasi dan Rekacipta" },
    ] },
    { name: "Sukan dan Permainan", children: [
      { name: "Kelab Petanque/Bowles" },
      { name: "Kelab Bola Jaring" },
      { name: "Kelab Bola Tampar" },
      { name: "Kelab Bola Baling" },
      { name: "Kelab Bola Sepak" },
      { name: "Kelab Olahraga/Merentas Desa" },
      { name: "Kelab Catur" },
      { name: "Kelab Sepak Takraw" },
      { name: "Kelab Badminton" },
      { name: "Kelab Ping Pong" },
      { name: "Kelab Woodball" },
    ] },
    { name: "Pasukan Sekolah yang Tiada Kelab", children: [
      { name: "Silat" },
      { name: "Memanah" },
      { name: "Taekwando" },
    ] },
    { name: "Setiausaha Sukan" },
    { name: "Rumah Sukan" },
    { name: "Koperasi Sekolah" },
    { name: "Majalah Sekolah" },
  ] },
