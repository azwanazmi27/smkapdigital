...
type Linked={mappingBasis:string;sourceModule:string;id:string;title:string;category:string;folderId:string;openUrl:string;mappingStatus:string;standardCode:string};
