...
function AIStatusList(){
  ...
  return <div className={`bang-wan-status ${online?"online":"offline"}`} role="status" aria-label={`Bang Wan ${online?"Online":"Offline"}`}><img className="bang-wan-robot" src="/bang-wan-opr.png" alt="" aria-hidden="true"/><div><strong>Bang Wan</strong><b><i aria-hidden="true"/>{online?"Online":"Offline"}</b></div></div>;
}
