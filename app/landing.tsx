...
export function LandingPortal() {
  ...
  return <main className="landing-shell">
    ...
    {welcome&&identity&&<LoginWelcome user={identity} close={()=>{setWelcome(false);if(unreadStaffAnnouncements().length)window.setTimeout(()=>setStaffAnnouncementOpen(true),180)}}/>}
