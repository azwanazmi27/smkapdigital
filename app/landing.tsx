...
const monitoringFacilities = ["Pusat Sumber Sekolah", "Pusat Akses", "Bilik Gerakan", "Makmal Komputer 1", "Makmal Komputer 2", "Makmal Sains", "Bilik KKQ", "Surau", "Kantin", "Dewan Makan", "Aspura", "Aspuri"];
