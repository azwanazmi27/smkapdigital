...
function ReliefIntegratedApp({user,close}:{user:PortalIdentity|null;close:()=>void}) {
  const [ready, setReady] = useState(false);
  return <div className="relief-integrated-shell">
    <button type="button" className="relief-return" onClick={close}>← Kembali ke Guru &amp; Staf</button>
