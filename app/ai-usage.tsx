...
export function AIUsageNote(){
 ...
 return <small className="ai-usage-note" aria-live="polite">{usage?(usage.exempt?`Akaun pentadbir: tiada had harian · ${usage.used} permintaan hari ini`:`Baki AI hari ini: ${usage.remaining} daripada ${usage.limit} permintaan`):'Baki AI akan dipaparkan selepas semakan akaun.'} · Had harian dikongsi antara fungsi AI dan diperbaharui pada 12 tengah malam waktu Malaysia.</small>;
}
